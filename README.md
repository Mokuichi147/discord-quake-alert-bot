...
scripts/
  audit_p2p_points.py … P2P履歴と観測点名の一致監査
  update_observation_stations.py … 公開JSONからの観測点TSV更新
```
